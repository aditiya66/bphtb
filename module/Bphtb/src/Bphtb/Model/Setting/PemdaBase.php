...
class PemdaBase implements InputFilterAwareInterface {    
    ...
    public function exchangeArray($data){        
        ...
        $this->s_namakabkot = (isset($data['s_namakabkot'])) ? $data['s_namakabkot'] : null;
        $this->s_namaibukotakabkot = (isset($data['s_namaibukotakabkot'])) ? $data['s_namaibukotakabkot'] : null;
