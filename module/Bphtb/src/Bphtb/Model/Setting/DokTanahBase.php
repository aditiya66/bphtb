...
class DokTanahBase implements InputFilterAwareInterface {

    public $s_iddoktanah, $s_namadoktanah;
    ...
    public function exchangeArray($data) {
        $this->s_iddoktanah = (isset($data["s_iddoktanah"])) ? $data["s_iddoktanah"] : null;
        $this->s_namadoktanah = (isset($data["s_namadoktanah"])) ? $data["s_namadoktanah"] : null;       
